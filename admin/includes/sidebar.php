...
<aside id="modernSidebar" class="modern-sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <div class="menu-item-wrapper">
            ...
            <a href="medicamentos_form.php" class="add-btn" title="Cadastrar medicamento">
        ...
        <div class="menu-item-wrapper">
            <a href="pacientes.php" class="menu-item <?php echo in_array($currentPath, ['pacientes.php', 'pacientes_form.php']) ? 'active' : ''; ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
        ...
        <div class="menu-item-wrapper">
            ...
            <a href="usuarios.php" class="add-btn" title="Gerenciar usuários">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/>
                </svg>
            </a>

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!verificarCSRFToken($csrfToken)) {
        ...
        if ($action === 'upload_photo' && isset($_FILES['foto'])) {
            ...
            } elseif (!in_array($foto['type'], $allowed_types)) {
            ...
            <header>
                <div class="space-y-2 sm:space-y-3">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm sm:text-base text-slate-500 max-w-2xl">Gerencie suas informações pessoais e configurações de conta</p>
                    </div>
                </div>
            </header>

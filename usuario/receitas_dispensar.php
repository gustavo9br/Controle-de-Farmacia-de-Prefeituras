...
<body class="admin-shell bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 min-h-screen">
    ...
    <script>
        ...
        async function deletarReceita() {
            try {
                const response = await fetch('../admin/api/deletar_receita.php', {
                    method: 'POST',
                    headers: {
        ...
        async function carregarLotes(medicamentoId) {
            ...
            try {
                const response = await fetch(`../admin/api/buscar_lotes.php?medicamento_id=${medicamentoId}`);
                const data = await response.json();
        ...
        async function buscarLotePorCodigoDispensar() {
            ...
            try {
                const response = await fetch(`../admin/api/buscar_lote_por_codigo.php?codigo_barras=${encodeURIComponent(codigoBarras)}&medicamento_id=${medicamentoId}`);
                const data = await response.json();
        ...
        document.getElementById('formDispensacao').addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('../admin/api/dispensar_receita.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function deletarDispensacaoReceita(retiradaId, dispensacaoId, receitaItemId) {
            ...
            try {
                const response = await fetch('../admin/api/deletar_dispensacao_receita.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },

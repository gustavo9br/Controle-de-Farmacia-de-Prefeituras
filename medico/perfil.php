...
<body class="admin-shell">
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 px-4 py-6 sm:px-6 sm:py-8 lg:px-12 lg:py-10 space-y-6 lg:space-y-8">
            ...
            <div class="glass-card p-6 lg:p-8 space-y-4">
                <h2 class="text-lg font-semibold text-slate-900 border-b border-white/60 pb-3">Informações da Conta</h2>

                <div class="grid gap-4 sm:grid-cols-3">
                    <div>
                        <span class="text-sm text-slate-500">Tipo de conta</span>
                        <p class="text-sm font-semibold text-slate-900 mt-1"><?php echo $typeLabels[$usuario['tipo']] ?? ucfirst($usuario['tipo']); ?></p>
                    </div>
                    <div>
                        <span class="text-sm text-slate-500">Status</span>
                        <p class="text-sm font-semibold mt-1">
                            <span class="inline-flex items-center gap-1 rounded-full <?php echo $usuario['status'] === 'ativo' ? 'bg-emerald-100 text-emerald-700' : 'bg-rose-100 text-rose-700'; ?> px-3 py-1">
                                <?php echo ucfirst($usuario['status']); ?>
                            </span>
                        </p>
                    </div>
                    <div>
                        <span class="text-sm text-slate-500">Membro desde</span>
                        <p class="text-sm font-semibold text-slate-900 mt-1"><?php echo date('d/m/Y', strtotime($usuario['data_cadastro'])); ?></p>
                    </div>
                </div>
            </div>
        </main>
